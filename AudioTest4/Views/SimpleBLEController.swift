...
//            panning: 0.5 ))
        ...
        if let dataFromString = jsonManifest.data(using: .utf8, allowLossyConversion: false) {
            ...
            for (_,beaconJson):(String, JSON) in json["soundsOfSelf"] {
                ...
                startMonitoringItem(item: BeaconInfo(name: beaconJson["beaconAlias"].stringValue,
